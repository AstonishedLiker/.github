![Profile Banner](../main/assets/banner.png)
...
Today, I focus on **program protection**, **reverse engineering**, and **secure system design**, not just as technical challenges, but as ways to preserve integrity, trust, and innovation in software.

I aim to pursue a **Master II in Cybersecurity** through a *Grande École* pathway after preparatory classes (MP2I/MPSI), and eventually contribute to high-impact security research and development.

## ⚙️ Projects

### 🏗️ [Solder](https://github.com/1suite/Solder)
*A Luau bundler for Roblox `.rbxm`/`.rbxmx` models.*  
Combines scripts and folders into a single module, supports optional runtime macros, and preserves hierarchy for seamless integration.
